...
export default function EditPropertyChannelModal({
    ...
    if (isOpen) {
      ...
      if (propertyChannel) {
        ...
        setFormData({
          ...
          apply_vat: propertyChannel.apply_vat ?? true,
          vat_percent: propertyChannel.vat_percent ?? 21,
        })
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Actualizar tambi̩n el channel_id si ha cambiado
      const updateData = {
        ...formData,
  ...
  const selectedChannel = availableChannels.find(channel => channel.id === selectedChannelId) || propertyChannel

  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Editar Canal de Distribuci&oacute;n</DialogTitle>
          <DialogDescription>
            Modifica la configuraci&oacute;n del canal de distribuci&oacute;n
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Label htmlFor="apply_vat">Aplicar IVA</Label>
                </div>
                <Switch
                  id="apply_vat"
                  checked={formData.apply_vat}
                  onCheckedChange={(checked) => 
                    setFormData(prev => ({ ...prev, apply_vat: checked }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 w-full">
                  <Label htmlFor="vat_percent" className="whitespace-nowrap">% IVA</Label>
                  <Input
                    id="vat_percent"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => 
                      setFormData(prev => ({ ...prev, vat_percent: parseFloat(e.target.value) || 0 }))
                    }
